...
module.exports = (app, keycloak) => {
 ...
 app.all(['/', 
    // '/get', '/:slug/get', '/:slug/get/dial/:dialCode',  '/get/dial/:dialCode', '/explore',
    ...
    // '/sign-in/*', '/download/*', '/accountMerge/*', '/:slug/download/*', '/certs/*', '/recover/*',
    '/public/certs/*'], redirectTologgedInPage, indexPage(false))
  ...
  app.all(['/workspace/*', '/profile', '/profile/*',
    ...
    // '/resources/*', '/myActivity', '/myActivity/*', '/org/*', '/manage'
